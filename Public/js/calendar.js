...
t_day = today.getDate();
var ca_htm = '';
ca_htm += '<table width="100%" cellpadding="0" cellspacing="0" style="background:#029BE2;"><tr>';
ca_htm += '<td style="color:#FFFFFF;-moz-user-select:none;" height="20" onselectstart="return false">&nbsp; <span onclick="ca_prev_year();" onmousedown="ca_setInterval(\'ca_prev_year\');" onmouseup="ca_clearInterval();" style="font-weight:bold;cursor:pointer;color:#ffffff;" title="'+L['prev_year']+'">&laquo;</span> <input type="text" maxlength="4" style="width:35px;border:none;color:#FFFFFF;text-align:center;background:#029BE2;padding:0 0 2px 0;" id="ca_year" onblur="ca_this_year();" ondblclick="this.value=\'\';"/> <span onclick="ca_next_year();" onmousedown="ca_setInterval(\'ca_next_year\');" onmouseup="ca_clearInterval();" style="font-weight:bold;cursor:pointer;color:#ffffff;" title="'+L['next_year']+'">&raquo;</span>  &nbsp;&nbsp; <span onclick="ca_prev_month();" onmousedown="ca_setInterval(\'ca_prev_month\');" onmouseup="ca_clearInterval();" style="font-weight:bold;cursor:pointer;color:#ffffff;" title="'+L['prev_month']+'">&laquo;</span> <input type="text" maxlength="2" style="width:16px;border:none;color:#FFFFFF;text-align:center;background:#029BE2;padding:0 0 2px 0;" id="ca_month" onblur="ca_this_month();" ondblclick="this.value=\'\';"/> <span onclick="ca_next_month();" onmousedown="ca_setInterval(\'ca_next_month\');" onmouseup="ca_clearInterval();" style="font-weight:bold;cursor:pointer;color:#ffffff;" title="'+L['next_month']+'">&raquo;</span> </td>';
ca_htm += '<td align="right" style="color:red;font-weight:bold;cursor:pointer;" onclick="ca_close();" title="Close">&#215;&nbsp;</td></tr></table>';
...
function ca_show(id, obj, sep) {
	...
	Dd('d_calendar').style.top = (obj.offsetTop + toppos + 29) + 'px';
