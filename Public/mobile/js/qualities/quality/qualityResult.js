layui.use(['flow', 'util', 'layer'], function () {
    ...
    function listUl(data) {
        ...
        html += '<li><span class="detailText">计划状态：</span><span class="text">' + data.status_name + '</span></li>';
    ...
    function show_no_data() {
        ...
        var html = '<div class="no_data">\n' +
            ...
            '          <div class="no_data_tips">暂无相关质控计划</div>\n' +
            '       </div>';
        $('#qualityResult').after(html);
    }
