layui.use(['flow', 'util', 'layer', 'element'], function () {
    ...
    $(".orderTypeButton").click(function () {
        $("#borrowAssetsList").remove();    
        $(document).unbind('scroll');
        $('#layui-card-body').append('<ul id="borrowAssetsList"></ul>');
        var params = {};
    ...
    function refreshList(data) {
        $('.no_data').remove();
        var html = '<li>';
        html += '<div class="content" data-id="'+data.assid+'">';
    ...
    //扫码申请借调
    $(document).on('click','#borrowAssetsListbrcode',function(){
        wx.scanQRCode({
            ...
            success: function (res) {
                ...
                window.location.href = mobile_name+'/Borrow/applyBorrow.html?assnum=' + assnum;
            }
        });
    });
