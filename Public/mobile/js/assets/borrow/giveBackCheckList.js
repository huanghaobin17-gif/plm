layui.use(['flow', 'util', 'layer', 'element'], function () {
    ...
    function listUl(data) {
        ...
        html += '<li><span class="detailText">申请科室：</span><span class="text">' + data.apply_department + '</span></li>';
        html += '<li><span class="detailText list_title_3">申请人：</span><span class="text">' + data.apply_user + '</span></li>';
        html += '<li><span class="detailText">预计归还：</span><span class="text">' + data.estimate_back + '</span></li>';
        html += '</ul>';
        return html;
    }
