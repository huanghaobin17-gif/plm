...
function Dmsg(str, i, s, t) {
	...
	try{if(s){window.scrollTo(0,0);}Ds('d'+i);Dd('d'+i).innerHTML = '<img src="/sbsys/images/check_error.gif" width="12" height="12" align="absmiddle"/> '+str+sound('tip');Dd(i).focus();}catch(e){}
	window.setTimeout(function(){Dd('d'+i).innerHTML = '';Dh('d'+i);}, t);
}
...
function sound(f) {return '<div style="float:left;"><embed src="flash/'+f+'.swf" quality="high" type="application/x-shockwave-flash" height="0" width="0" hidden="true"/></div>';}
function Eh(t) {
	var t = t ? t : 'select';
	if(isIE) {
