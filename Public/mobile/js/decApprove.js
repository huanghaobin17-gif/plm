...
$(function(){
    $("#hisApNextPage").click(function(){
        ...
        var url = '/index.php/Home/Repair/declaraApproveLists/type/his/p/'+p;
        $.ajax({
            type:"GET",
            url:url,
            //返回数据的格式
    ...
    $("#nowApNextPage").click(function(){
        var p = $(this).attr('title');
        var url = '/index.php/Home/Repair/declaraApproveLists/type/now/p/'+p;
        $.ajax({
            type:"GET",
            url:url,
            //返回数据的格式
...
function getDetail(repid) {
    window.location.href = "/index.php/Home/Repair/getApproveDetail/repid/" + repid;
}
function getDecDetail(repid,assid) {
    window.location.href = "/index.php/Home/Repair/getDecApproveDetail/assid/"+assid+"/repid/" + repid;
}