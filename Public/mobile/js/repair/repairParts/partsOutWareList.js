layui.use(['flow', 'util', 'layer'], function () {
    ...
    function refreshList(data) {
        ...
        var html = '<li>\n' +
            ...
            '                                    </li>\n' +
            '                                    <li>\n' +
            '                                        <span class="detailText">配件数量 <span style="color:red;">'+data.parts_num+'</span></span>\n' +
            '                                    </li>\n' +
            '                                    <li>\n' +
            '                                        <span class="detailText">'+data.department+'</span>\n' +
            '                                        <span class="text">'+data.show_time+'</span>\n' +
            '                                    </li>\n' +
            '                                </ul>\n' +
            '                            </div>\n' +
            '                        </div>\n' +
    ...
    function show_no_data() {
        ...
        var html = '<div class="no_data">\n' +
            ...
            '          <div class="no_data_tips">暂无需处理的出库单</div>\n' +
            '       </div>';
        $('#partsOutWareList').after(html);
    }
