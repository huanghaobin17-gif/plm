...
var defaultOptions = {
  ...
  imageResourcesPath: {
    value: '/Public/mobile/js/archives/emergency/pdf/web/images/',
    kind: OptionKind.VIEWER
  },
  maxCanvasPixels: {
    value: 16777216,
  ...
  cMapUrl: {
    value: '/Public/mobile/js/archives/emergency/pdf/web/cmaps/',
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  workerSrc: {
    value: '/Public/mobile/js/archives/emergency/pdf/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
