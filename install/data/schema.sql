...
-- ----------------------------
-- Table structure for sb_adverse_info
-- ----------------------------
DROP TABLE IF EXISTS `sb_adverse_info`;
CREATE TABLE `sb_adverse_info` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `hospital_id` int(11) DEFAULT NULL COMMENT '医院ID',
  `assid` int(11) NOT NULL DEFAULT '0' COMMENT '资产ID组',
  `report_date` date DEFAULT '0000-00-00' COMMENT '报告日期',
  `report_from` varchar(10) DEFAULT NULL COMMENT '报告来源',
  `address` varchar(128) DEFAULT NULL COMMENT '联系地址',
  `code` varchar(25) DEFAULT NULL COMMENT '编码',
  `unit` varchar(25) DEFAULT NULL COMMENT '单位名称',
  ...
  `sex` tinyint(3) DEFAULT NULL COMMENT '性别【1男0女】',
  `expected` text COMMENT '预期治疗疾病或者作用',
  `express` text COMMENT '事件主要表现',
  `express_date` date DEFAULT NULL COMMENT '事件发生时间',
  `discovery` varchar(64) DEFAULT NULL COMMENT '发现或知悉事件',
  `place` varchar(64) DEFAULT NULL COMMENT '医疗器械实际使用场所',
  `consequence` text COMMENT '事件后果',
  `report` varchar(255) DEFAULT NULL COMMENT '上传的文件',
  `reporter` varchar(10) DEFAULT NULL COMMENT '报告人职称',
  `sign` varchar(32) DEFAULT NULL COMMENT '报告人签字',
  `assets` varchar(64) DEFAULT NULL COMMENT '产品名称',
  `commodity` varchar(64) DEFAULT NULL COMMENT '商品名称',
  `register_num` varchar(64) DEFAULT NULL COMMENT '注册证号',
  `company` varchar(64) DEFAULT NULL COMMENT '生产企业名称',
  `company_address` varchar(64) DEFAULT NULL COMMENT '生产企业地址',
  `company_contract` varchar(64) DEFAULT NULL COMMENT '企业联系地址',
  `model` varchar(32) DEFAULT NULL COMMENT '产品型号',
  `assnum` varchar(32) DEFAULT NULL COMMENT '产品编号',
  `assets_batch_num` varchar(32) DEFAULT NULL COMMENT '产品批号',
  `operator` varchar(32) DEFAULT NULL COMMENT '操作人',
  `validity_date` date DEFAULT NULL COMMENT '有效期至',
  `manufacture_date` date DEFAULT NULL COMMENT '生产日期',
  `discontinuation_date` date DEFAULT NULL COMMENT '停用日期',
  `implantation_date` date DEFAULT NULL COMMENT '植入日期',
  `cause` text COMMENT '事件发生初步原因分析',
  `situation` text COMMENT '事件初步处理情况',
  `report_status` varchar(20) DEFAULT NULL COMMENT '事件报告状态【1已通知使用单位 2已通知生产企业 3已通知经营企业 4已通知药监部门】',
  `provincial_monitoring` text COMMENT '省级监测技术机构评价意见',
  `state_monitoring` text COMMENT '国家监测技术机构评价意见',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '不良事件报告状态[0=''暂存可编辑'',1=''结束不可编辑'']',
  `adduser` varchar(30) NOT NULL DEFAULT '' COMMENT '添加记录人',
  `addtime` datetime DEFAULT NULL COMMENT '添加时间',
  `edituser` varchar(30) DEFAULT NULL COMMENT '修改记录人',
  `edittime` datetime DEFAULT NULL COMMENT '修改时间',
  `Filename` varchar(255) DEFAULT NULL COMMENT '文件原名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='不良事件——器械不良事件';

-- ----------------------------
-- Records of sb_adverse_info
-- ----------------------------
BEGIN;
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='审批设置——审批类型';
...
INSERT INTO `sb_assets_print_temp` (`temp_id`, `hospital_id`, `printer_type`, `system_default`, `temp_name`, `show_fields`, `temp_content`, `is_select`, `pic_width`, `font_size`, `add_user`, `add_time`, `edit_user`, `edit_time`) VALUES (20, 1, 'brother', 1, 'system_3', '{\"assets\":\"设备名称\",\"model\":\"规格型号\",\"assnum\":\"设备编号\",\"department\":\"使用科室\",\"opendate\":\"启用日期\"}', '<div class=\"system_3\">\n    <div class=\"hospital_name\" style=\"font-size:16px;height:18px;line-height:18px;padding-right: 10px;font-family: 宋体;\">郴州市第三人民医院</div>\n    <div class=\"hospital_info\">\n        <table class=\"czsy_table\">\n            <tbody>\n            <tr>\n                <td class=\"czsy_title\"></td>\n                <td><div class=\"czsy_con\"></div></td>\n            </tr>\n            <tr>\n                <td class=\"czsy_title\"></td>\n                <td><div class=\"czsy_con\"></div></td>\n            </tr>\n            <tr>\n                <td class=\"czsy_title\"></td>\n                <td><div class=\"czsy_con\"></div></td>\n            </tr>\n            <tr>\n                <td class=\"czsy_title\"></td>\n                <td><div class=\"czsy_con\"></div></td>\n            </tr>\n            <tr>\n                <td class=\"czsy_title\"></td>\n                <td><div class=\"czsy_con\"></div></td>\n            </tr>\n            </tbody>\n        </table>\n    </div>\n    <div class=\"czsy_barcode\">\n        <img src=\"/Public/images/show_qrcode_1.png\"/>\n        <div style=\"color: #000000;font-size: 11px;width: 105px;overflow: hidden;\">6858011371866</div>\n    </div>\n</div>\n<div class=\"layui-btn-group\" style=\"width:100%;text-align: center;margin-top:10px;\">\n    <button type=\"button\" class=\"layui-btn layui-btn-sm default\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zsave\"></i>设为默认\n    </button>\n    <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-normal print_test\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zprinter-l\" style=\"font-size: 16px;\"></i>打印测试\n    </button>\n</div>\n\n', 0, 70, 16, '牛年', NULL, NULL, NULL);
INSERT INTO `sb_assets_print_temp` (`temp_id`, `hospital_id`, `printer_type`, `system_default`, `temp_name`, `show_fields`, `temp_content`, `is_select`, `pic_width`, `font_size`, `add_user`, `add_time`, `edit_user`, `edit_time`) VALUES (25, 1, 'brother', 1, 'system_4', '{\"zidingyi\":\"固定资产管理卡\",\"hos_name\":\"天成医疗测试医院\",\"assets\":\"设备名称\",\"model\":\"规格型号\",\"assnum\":\"设备编号\",\"department\":\"使用科室\",\"opendate\":\"启用日期\"}', '<div class=\"system_4\">\r\n    <table class=\"czsy_table\">\r\n        <tbody>\r\n            <tr>\r\n                <td colspan=\"2\"></td>\r\n                <td rowspan=\"6\">\r\n                    <img class=\"czsy_barcode\" src=\"/Public/images/show_qrcode_1.png\"/>\r\n                </td>\r\n            </tr>\r\n            <tr>\r\n                <td colspan=\"2\"></td>\r\n            </tr>\r\n            <tr>\r\n                <td class=\"czsy_title\"></td>\r\n                <td><div class=\"czsy_con\"></div></td>\r\n            </tr>\r\n            <tr>\r\n                <td class=\"czsy_title\"></td>\r\n                <td><div class=\"czsy_con\"></div></td>\r\n            </tr>\r\n            <tr>\r\n                <td class=\"czsy_title\"></td>\r\n                <td><div class=\"czsy_con\"></div></td>\r\n            </tr>\r\n            <tr>\r\n                <td class=\"czsy_title\"></td>\r\n                <td><div class=\"czsy_con\"></div></td>\r\n            </tr>\r\n            <tr>\r\n                <td class=\"czsy_title\"></td>\r\n                <td><div class=\"czsy_con\"></div></td>\r\n                <td><div class=\"bot_assnum\">68560211933081</div></td>\r\n            </tr>\r\n        </tbody>\r\n    </table>\r\n</div>\r\n<div class=\"layui-btn-group\" style=\"width:100%;text-align: center;margin-top:10px;\">\r\n    <button type=\"button\" class=\"layui-btn layui-btn-sm default\" style=\"margin: 0 0 0 60px;\">\r\n        <i class=\"layui-icon layui-icon-zsave\"></i>设为默认\r\n    </button>\r\n    <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-normal print_test\" style=\"margin: 0 0 0 60px;\">\r\n        <i class=\"layui-icon layui-icon-zprinter-l\" style=\"font-size: 16px;\"></i>打印测试\r\n    </button>\r\n</div>\r\n', 0, 90, 12, '牛年', NULL, NULL, NULL);
INSERT INTO `sb_assets_print_temp` (`temp_id`, `hospital_id`, `printer_type`, `system_default`, `temp_name`, `show_fields`, `temp_content`, `is_select`, `pic_width`, `font_size`, `add_user`, `add_time`, `edit_user`, `edit_time`) VALUES (31, 1, 'brother', 0, 'user_3', '{\"assets\":\"设备名称\",\"assnum\":\"设备编号\",\"department\":\"使用科室\",\"model\":\"规格型号\",\"opendate\":\"启用日期\"}', '<div class=\"user_3\">\n    <div class=\"hospital_name\" style=\"font-size:16px;height:18px;line-height:18px;padding-right: 10px;font-family: 宋体;\">郴州市第三人民医院</div>\n    <div class=\"hospital_info\">\n        <table class=\"czsy_table\">\n            <tbody>\n            <tr>\n                <td class=\"czsy_title\"></td>\n                <td><div class=\"czsy_con\"></div></td>\n            </tr>\n            <tr>\n                <td class=\"czsy_title\"></td>\n                <td><div class=\"czsy_con\"></div></td>\n            </tr>\n            <tr>\n                <td class=\"czsy_title\"></td>\n                <td><div class=\"czsy_con\"></div></td>\n            </tr>\n            <tr>\n                <td class=\"czsy_title\"></td>\n                <td><div class=\"czsy_con\"></div></td>\n            </tr>\n            <tr>\n                <td class=\"czsy_title\"></td>\n                <td><div class=\"czsy_con\"></div></td>\n            </tr>\n            </tbody>\n        </table>\n    </div>\n    <div class=\"czsy_barcode\">\n<img src=\"/Public/images/show_qrcode_1.png\" style=\"width: 95px;margin-top: 0px;\"/>        <div style=\"color: #000000;font-size: 12px;width: 105px;overflow: hidden;\">6858011371866</div>\n    </div>\n</div>\n<div class=\"layui-btn-group\" style=\"width:100%;text-align: center;margin-top:10px;\">\n    <button type=\"button\" class=\"layui-btn layui-btn-sm default\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zsave\"></i>设为默认\n    </button>\n    <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-normal print_test\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zprinter-l\" style=\"font-size: 16px;\"></i>打印测试\n    </button>\n    <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-danger delete\" style=\"margin: 0 0 0 60px;\">\n       <i class=\"layui-icon\">&#xe640;</i>删除标签\n</button>\n</div>\n', 0, 95, 10, '牛年', '2019-08-20 15:18:34', '牛年', '2022-12-09 14:39:23');
INSERT INTO `sb_assets_print_temp` (`temp_id`, `hospital_id`, `printer_type`, `system_default`, `temp_name`, `show_fields`, `temp_content`, `is_select`, `pic_width`, `font_size`, `add_user`, `add_time`, `edit_user`, `edit_time`) VALUES (34, 1, 'zebra', 0, 'user_1', '{\"department\":\"使用科室\",\"assets\":\"设备名称\",\"model\":\"规格型号\",\"assnum\":\"设备编号\",\"opendate\":\"启用日期\",\"category\":\"设备分类\"}', '<div class=\"user_1\">\n    <div class=\"hospital_name\"></div>\n    <div class=\"hospital_info\">\n        <table class=\"show_table\">\n            <tbody>\n            <tr>\n                <td colspan=\"2\" class=\"line_height\"></td>\n            </tr>\n             <tr>\n                <td colspan=\"2\" class=\"line_height\"></td>\n            </tr>\n            <tr>\n                <td colspan=\"2\" class=\"line_height\"></td>\n            </tr>\n            <tr>\n                <td class=\"row_td line_height\"></td>\n                <td class=\"td_img img_line_height\" rowspan=\"3\">\n<img src=\"/Public/images/show_qrcode_1.png\" style=\"width: 60px;margin-top: 0px;\"/>                </td>\n            </tr>\n            <tr>\n                <td class=\"row_td line_height\"></td>\n            </tr>\n            <tr>\n                <td class=\"row_td line_height\"></td>\n            </tr>\n            </tbody>\n        </table>\n    </div>\n</div>\n<div class=\"layui-btn-group\" style=\"width:100%;text-align: center;margin-top:10px;\">\n      <button type=\"button\" class=\"layui-btn layui-btn-sm default\" style=\"margin: 0 0 0 60px;\">\n         <i class=\"layui-icon layui-icon-zsave\"></i>设为默认\n      </button>\n      <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-normal print_test\" style=\"margin: 0 0 0 60px;\">\n         <i class=\"layui-icon layui-icon-zprinter-l\" style=\"font-size: 16px;\"></i>打印测试\n       </button>\n       <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-danger delete\" style=\"margin: 0 0 0 60px;\">\n           <i class=\"layui-icon\">&#xe640;</i>删除标签\n       </button>\n</div>', 0, 60, 18, '牛年', '2019-08-20 16:00:36', '牛年', '2023-04-07 14:21:28');
INSERT INTO `sb_assets_print_temp` (`temp_id`, `hospital_id`, `printer_type`, `system_default`, `temp_name`, `show_fields`, `temp_content`, `is_select`, `pic_width`, `font_size`, `add_user`, `add_time`, `edit_user`, `edit_time`) VALUES (35, 1, 'other', 1, 'system_5', NULL, '<div class=\"system_5\">\n    <div class=\"other_barcode\">\n        <img src=\"/Public/images/show_qrcode_1.png\"/>\n    </div>\n</div>\n<div>（兄弟打印机，纸张大小36mm,长度40mm）</div>\n<div class=\"layui-btn-group\" style=\"width:100%;text-align: center;\">\n    <button type=\"button\" class=\"layui-btn layui-btn-sm default\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zsave\"></i>设为默认\n    </button>\n    <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-normal print_test\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zprinter-l\" style=\"font-size: 16px;\"></i>打印测试    </button>\n</div>\n\n', 0, 70, 16, NULL, NULL, NULL, NULL);
INSERT INTO `sb_assets_print_temp` (`temp_id`, `hospital_id`, `printer_type`, `system_default`, `temp_name`, `show_fields`, `temp_content`, `is_select`, `pic_width`, `font_size`, `add_user`, `add_time`, `edit_user`, `edit_time`) VALUES (36, 1, 'other', 1, 'system_6', NULL, '<div class=\"system_6\">\n    <div class=\"other_barcode\">\n        <img src=\"/Public/images/show_qrcode_1.png\"/>\n    </div>\n</div>\n<div>（兄弟打印机，纸张大小24mm,长度30mm）</div>\n<div class=\"layui-btn-group\" style=\"width:100%;text-align: center;\">\n    <button type=\"button\" class=\"layui-btn layui-btn-sm default\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zsave\"></i>设为默认\n    </button>\n    <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-normal print_test\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zprinter-l\" style=\"font-size: 16px;\"></i>打印测试    </button>\n</div>\n\n', 0, 70, 16, NULL, NULL, NULL, NULL);
INSERT INTO `sb_assets_print_temp` (`temp_id`, `hospital_id`, `printer_type`, `system_default`, `temp_name`, `show_fields`, `temp_content`, `is_select`, `pic_width`, `font_size`, `add_user`, `add_time`, `edit_user`, `edit_time`) VALUES (37, 1, 'other', 1, 'system_7', NULL, '<div class=\"system_7\">\n    <div class=\"other_barcode\">\n        <img src=\"/Public/images/show_qrcode_1.png\"/>\n    </div>\n    <div class=\"xbh\">6854010904360</div>\n</div>\n<div>（纸张大小18mm,长度24mm,浏览器最小字体设置为8）</div>\n<div class=\"layui-btn-group\" style=\"width:100%;text-align: center;\">\n    <button type=\"button\" class=\"layui-btn layui-btn-sm default\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zsave\"></i>设为默认\n    </button>\n    <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-normal print_test\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zprinter-l\" style=\"font-size: 16px;\"></i>打印测试    </button>\n</div>\n\n', 0, 70, 16, NULL, NULL, NULL, NULL);
INSERT INTO `sb_assets_print_temp` (`temp_id`, `hospital_id`, `printer_type`, `system_default`, `temp_name`, `show_fields`, `temp_content`, `is_select`, `pic_width`, `font_size`, `add_user`, `add_time`, `edit_user`, `edit_time`) VALUES (43, 1, 'brother', 0, 'user_4', '{\"zidingyi\":\"sdsd\",\"hos_name\":\"广州天成医疗技术股份有限公司\",\"assets\":\"设备名称\",\"factorynum\":\"出厂编号\",\"model\":\"规格型号\",\"remark\":\"设备备注\",\"\":null}', '<div class=\"user_4\">\n            <table class=\"czsy_table\">\n               <tbody>\n                  <tr>\n                      <td colspan=\"2\"></td>\n                      <td rowspan=\"6\"><img src=\"/Public/images/show_qrcode_1.png\" style=\"width: 95px;margin-top: 0px;\"/></td>\n                  </tr>\n                  <tr>\n                      <td colspan=\"2\"></td>\n                  </tr>\n                  <tr>\n                      <td class=\"czsy_title\"></td>\n                      <td><div class=\"czsy_con\"></div></td>\n                  </tr>\n                  <tr>\n                      <td class=\"czsy_title\"></td>\n                      <td><div class=\"czsy_con\"></div></td>\n                  </tr>\n                  <tr>\n                      <td class=\"czsy_title\"></td>\n                      <td><div class=\"czsy_con\"></div></td>\n                  </tr>\n                  <tr>\n                      <td class=\"czsy_title\"></td>\n                      <td><div class=\"czsy_con\"></div></td>\n                  </tr>\n                  <tr>\n                      <td class=\"czsy_title\"></td>\n                      <td><div class=\"czsy_con\"></div></td>\n                      <td><div class=\"bot_assnum\">68560211933</div></td>\n                 </tr>\n              </tbody>\n          </table>\n</div>\n<div class=\"layui-btn-group\" style=\"width:100%;text-align: center;margin-top:10px;\">\n    <button type=\"button\" class=\"layui-btn layui-btn-sm default\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zsave\"></i>设为默认\n    </button>\n    <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-normal print_test\" style=\"margin: 0 0 0 60px;\">\n        <i class=\"layui-icon layui-icon-zprinter-l\" style=\"font-size: 16px;\"></i>打印测试\n    </button>\n    <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-danger delete\" style=\"margin: 0 0 0 60px;\">\n       <i class=\"layui-icon\">&#xe640;</i>删除标签\n</button>\n</div>\n', 0, 95, 12, '牛年', '2022-01-13 11:39:43', '牛年', '2022-12-09 14:40:39');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=79 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统基础——模块基础配置&设置';
...
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (2, 'assets', 'assets_helpcat', '[\"急救类\",\"生命支持类\",\"普通医疗设备\",\"普通医疗器械\",\"超声类\",\"制冷设备\",\"消毒灭菌设备\",\"血库设备\"]');
...
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (14, 'repair', 'repair_print_watermark', '{\"watermark\":\"广州天成医疗技术股份有限\"}');
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (15, 'repair', 'repair_tmp', '{\"style\":\"2\"}');
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (16, 'repair', 'repair_uptime', '120');
...
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (27, 'patrol', 'priceRange', '[\"0|50000\",\"50001|100000\",\"100001|999999\"]');
...
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (36, 'monitor', 'monitor_open', '{\"is_open\":\"0\"}');
...
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (43, 'repair', 'repair_category', '[\"项目内\",\"项目外\"]');
...
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (60, 'repair', 'open_sweepCode_overhaul', '{\"open\":\"1\"}');
...
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (68, 'all_module', 'all_report_logo', '\"\\/Public\\/uploads\\/allModuleLogo\\/20220520\\/6286fd7e0fefd.png\"');
...
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (71, 'assets', 'borrow_template', '{\"title\":\"广州天成医疗技术股份有限公司\"}');
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (72, 'assets', 'transfer_template', '{\"title\":\"广州天成医疗技术股份有限公司\"}');
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (73, 'assets', 'outside_template', '{\"title\":\"广州天成医疗技术股份有限公司\"}');
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (74, 'assets', 'scrap_template', '{\"title\":\"广州天成医疗技术股份有限公司\"}');
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (75, 'patrol', 'patrol_template', '{\"title\":\"\"}');
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (76, 'patrol', 'patrol_wx_set_situation', '0');
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (77, 'repair', 'life_assets_remind', '');
INSERT INTO `sb_base_setting` (`setid`, `module`, `set_item`, `value`) VALUES (78, 'repair', 'normal_assets_remind', '');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=553 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单表';
...
INSERT INTO `sb_menu` (`menuid`, `name`, `title`, `BaseSettingTitle`, `parentid`, `op_parentid`, `orderID`, `status`, `leftShow`, `icon`, `jump`, `tips`, `menuNotShow`) VALUES (206, 'Benefit', '数据分析', '数据分析', 0, NULL, 9, 1, 1, 'layui-icon-zzline-chart', '', NULL, 0);
...
INSERT INTO `sb_menu` (`menuid`, `name`, `title`, `BaseSettingTitle`, `parentid`, `op_parentid`, `orderID`, `status`, `leftShow`, `icon`, `jump`, `tips`, `menuNotShow`) VALUES (282, 'Monitor', '监控管理', '监控管理', 0, NULL, 12, 0, 1, 'layui-icon-zzthermometer-half', NULL, NULL, 0);
...
CREATE TABLE `sb_operation_log` (
  ...
  PRIMARY KEY (`logid`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统基础——用户行为日志表';

-- ----------------------------
-- Records of sb_operation_log
-- ----------------------------
BEGIN;
INSERT INTO `sb_operation_log` (`logid`, `username`, `module`, `controller`, `action`, `actionid`, `table`, `sql`, `ip`, `remark`, `action_time`) VALUES (1, 'admin', 'Login', NULL, 'login', NULL, NULL, NULL, '2887647233', '登录系统', '2025-01-13 16:18:12');
INSERT INTO `sb_operation_log` (`logid`, `username`, `module`, `controller`, `action`, `actionid`, `table`, `sql`, `ip`, `remark`, `action_time`) VALUES (2, 'admin', 'BaseSetting', 'Privilege', 'addRole', 1, 'sb_role', 'INSERT INTO `sb_role` (`role`,`remark`,`status`,`is_default`,`adduser`,`addtime`,`edituser`,`edittime`,`hospital_id`) VALUES (\'超级管理员\',\'\',\'1\',\'0\',\'admin\',\'1736756330\',\'admin\',\'1736756330\',\'1\')', '2887647233', '新增了一个角色《admin》', '2025-01-13 16:18:50');
INSERT INTO `sb_operation_log` (`logid`, `username`, `module`, `controller`, `action`, `actionid`, `table`, `sql`, `ip`, `remark`, `action_time`) VALUES (3, 'admin', 'BaseSetting', 'Privilege', 'editRolePrivi', 0, 'sb_user', NULL, '2887647233', '进行权限维护操作', '2025-01-13 16:19:04');
INSERT INTO `sb_operation_log` (`logid`, `username`, `module`, `controller`, `action`, `actionid`, `table`, `sql`, `ip`, `remark`, `action_time`) VALUES (4, 'admin', 'Login', NULL, 'logout', NULL, NULL, NULL, '2887647233', '手动退出系统', '2025-01-13 16:20:58');
INSERT INTO `sb_operation_log` (`logid`, `username`, `module`, `controller`, `action`, `actionid`, `table`, `sql`, `ip`, `remark`, `action_time`) VALUES (5, 'admin', 'Login', NULL, 'login', NULL, NULL, NULL, '2887647233', '登录系统', '2025-01-13 16:21:14');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=326 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='巡查保养——保养项目类型&明细表';
...
INSERT INTO `sb_patrol_points` (`ppid`, `num`, `name`, `parentid`, `remark`, `result`, `require`) VALUES (301, '300001', '类别明细-W-合格', 300, NULL, '合格', '');
INSERT INTO `sb_patrol_points` (`ppid`, `num`, `name`, `parentid`, `remark`, `result`, `require`) VALUES (302, '300002', '类别明细-W-修复', 300, NULL, '修复', '');
INSERT INTO `sb_patrol_points` (`ppid`, `num`, `name`, `parentid`, `remark`, `result`, `require`) VALUES (303, '300003', '类别明细-W-可用', 300, NULL, '可用', '');
INSERT INTO `sb_patrol_points` (`ppid`, `num`, `name`, `parentid`, `remark`, `result`, `require`) VALUES (304, '300004', '类别明细-W-待修', 300, NULL, '待修', '');
...
INSERT INTO `sb_patrol_points` (`ppid`, `num`, `name`, `parentid`, `remark`, `result`, `require`) VALUES (322, '294001', '设备关机状态下，机房紧急停机按钮功能', 294, NULL, '合格', '设备关机状态下，机房紧急停机按钮功能1111111');
INSERT INTO `sb_patrol_points` (`ppid`, `num`, `name`, `parentid`, `remark`, `result`, `require`) VALUES (323, '294002', '设备输入电压A-B', 294, NULL, '合格', '');
INSERT INTO `sb_patrol_points` (`ppid`, `num`, `name`, `parentid`, `remark`, `result`, `require`) VALUES (324, '294003', '设备输入电压B-C', 294, NULL, '合格', NULL);
INSERT INTO `sb_patrol_points` (`ppid`, `num`, `name`, `parentid`, `remark`, `result`, `require`) VALUES (325, '294004', '设备输入电压A-C', 294, NULL, '合格', NULL);
COMMIT;
...
CREATE TABLE `sb_purchases_depart_apply_checkassets_file` (
  ...
  PRIMARY KEY (`file_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=REDUNDANT COMMENT='采购管理——验收设备附件表';
...
INSERT INTO `sb_quality_detection_basis` (`qdbid`, `basis`, `content`, `adduserid`, `adddate`) VALUES (5, '特吃', '啊手动阀', 1, '2021-08-09 10:50:26');
INSERT INTO `sb_quality_detection_basis` (`qdbid`, `basis`, `content`, `adduserid`, `adddate`) VALUES (6, '检测依据标题-W', '&lt;p&gt;内容1&lt;/p&gt;&lt;p&gt;内容2&lt;/p&gt;', 179, '2023-03-03 15:09:57');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='质控管理——检测仪器表';

-- ----------------------------
-- Records of sb_quality_instruments
-- ----------------------------
BEGIN;
INSERT INTO `sb_quality_instruments` (`qiid`, `instrument`, `model`, `productid`, `metering_date`, `metering_place`, `metering_num`, `metering_report`, `addtime`, `adduser`, `edittime`, `edituser`) VALUES (1, '开测试', '123', '123', '2021-01-18', 'adf', 'asdfdf', '/Public/uploads/qualities/report/instruments/20210118/6004eda94bdd7.jpg', '2021-01-18 10:08:42', '牛年', NULL, NULL);
INSERT INTO `sb_quality_instruments` (`qiid`, `instrument`, `model`, `productid`, `metering_date`, `metering_place`, `metering_num`, `metering_report`, `addtime`, `adduser`, `edittime`, `edituser`) VALUES (2, '仪器名称-W', '规格/型号', 'CPXLH-W', '2023-03-03', '检定单位', 'JLBH', '/Public/uploads/qualities/report/instruments/20230303/6401af73000d7.pdf', '2023-03-03 16:27:35', '王喜娟', '2023-04-06 08:38:30', '牛年');
INSERT INTO `sb_quality_instruments` (`qiid`, `instrument`, `model`, `productid`, `metering_date`, `metering_place`, `metering_num`, `metering_report`, `addtime`, `adduser`, `edittime`, `edituser`) VALUES (3, '二人2', '维保', '444545', '2023-03-31', '77', '44', '/Public/uploads/qualities/report/instruments/20230331/64264f1641bf1.jpg', '2023-03-31 11:10:15', '牛年', '2023-08-02 15:51:52', '牛年');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统基础——角色管理';

-- ----------------------------
-- Records of sb_role
-- ----------------------------
BEGIN;
INSERT INTO `sb_role` (`roleid`, `hospital_id`, `role`, `remark`, `status`, `adduser`, `addtime`, `edituser`, `edittime`, `is_default`, `is_delete`) VALUES (1, 1, '超级管理员', '', 1, 'admin', 1736756330, 'admin', 1736756330, 0, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 24);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 25);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 26);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 27);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 136);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 138);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 139);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 28);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 31);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 220);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 116);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 117);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 129);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 130);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 147);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 149);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 205);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 526);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 35);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 36);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 37);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 233);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 69);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 71);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 163);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 234);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 38);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 290);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 291);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 292);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 295);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 322);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 323);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 293);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 294);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 297);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 298);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 405);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 324);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 326);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 328);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 325);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 327);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 329);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 494);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 496);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 498);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 495);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 497);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 499);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 502);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 503);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 50);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 52);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 236);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 80);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 82);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 83);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 53);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 44);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 45);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 46);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 47);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 48);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 137);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 169);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 171);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 78);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 79);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 86);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 90);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 96);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 97);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 145);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 482);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 483);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 484);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 486);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 487);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 54);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 55);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 56);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 518);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 118);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 132);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 133);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 135);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 179);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 520);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 57);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 58);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 59);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 119);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 121);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 122);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 125);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 126);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 127);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 128);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 521);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 522);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 523);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 203);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 191);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 197);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 200);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 201);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 229);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 192);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 193);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 194);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 195);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 196);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 199);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 202);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 511);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 512);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 238);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 254);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 242);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 243);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 252);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 253);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 272);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 218);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 219);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 225);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 208);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 209);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 210);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 214);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 216);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 532);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 533);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 534);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 535);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 416);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 419);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 420);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 417);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 418);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 455);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 476);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 492);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 506);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 65);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 66);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 67);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 76);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 105);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 106);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 107);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 110);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 111);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 112);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 113);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 162);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 68);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 74);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 77);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 87);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 88);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 89);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 299);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 63);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 64);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 102);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 103);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 104);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 184);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 524);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 530);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 174);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 91);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 92);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 114);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 230);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 183);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 188);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 189);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 232);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 407);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 472);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 477);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 408);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 409);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 410);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 473);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 474);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 475);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 478);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 479);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 480);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 500);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 505);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 514);
INSERT INTO `sb_role_menu` (`roleid`, `menuid`) VALUES (1, 515);
COMMIT;
...
CREATE TABLE `sb_user` (
  ...
  `qy_user_id` varchar(255) DEFAULT NULL COMMENT '企业微信user_id',
...
-- ----------------------------
BEGIN;
INSERT INTO `sb_user` (`userid`, `qy_user_id`, `job_hospitalid`, `manager_hospitalid`, `code`, `openid`, `nickname`, `job_departid`, `usernum`, `username`, `password`, `gender`, `telephone`, `status`, `logintime`, `logintimes`, `addid`, `remark`, `is_super`, `is_supplier`, `olsid`, `identifier`, `token`, `timeout`, `add_time`, `edit_time`, `expire_time`, `email`, `pic`, `is_delete`, `authorization`, `state`, `autograph`, `set_password_time`, `wx_public_account`) VALUES (1, NULL, 1, '1', NULL, '', NULL, 0, 1, 'admin', 'oy8oaEkiqJWJXtqFNPhfgg==', 1, '13800138000', 1, 1736756474, 3, 0, '', 1, 0, 0, NULL, NULL, NULL, NULL, '2025-01-13 16:21:32', NULL, 'admin@admin.com', NULL, 0, NULL, NULL, NULL, '2025-01-13 16:21:32', 0);
COMMIT;
