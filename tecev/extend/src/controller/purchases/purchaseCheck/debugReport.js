layui.define(function(exports){
    layui.use(['form','upload'], function(){
        ...
        form.render();
        //监听提交
        form.on('submit(saveDebug)', function(data){
            var params = data.field;
            submit($,params,'debugReport');
            return false;
        });
        //上传附件
        upload.render({
            elem: '#addReport'  //绑定元素
            , url: admin_name+'/PurchaseCheck/debugReport' //接口
            , accept: 'file'
    ...
    exports('controller/purchases/purchaseCheck/debugReport', {});
});
