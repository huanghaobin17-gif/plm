layui.define(function(exports){
    layui.use(['form','laydate','element','upload'], function(){
        var $ = layui.$
            ...
            ,form = layui.form;
        laydate.render({
            elem: '#checkAssetsDetailsArrival_date'
        });
        laydate.render({
            elem: '#checkAssetsDetailsCheck_date'
        });
        laydate.render({
            elem: '#checkAssetsDetailsFactorydate'
        });
        laydate.render({
            elem: '#checkAssetsDetailsOpendate'
        });
        form.render();
    ...
    exports('controller/purchases/purchaseCheck/showcheckAssetsDetails', {});
});