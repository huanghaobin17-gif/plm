layui.define(function(exports){
    layui.use(['form','upload'], function(){
        ...
        form.render();
        //监听提交
        form.on('submit(saveMeteringReport)', function(data){
            var params = data.field;
            params.action = 'finalSave';
            submit($,params,'firstMetering');
            return false;
        });
        //上传附件
        upload.render({
            elem: '#addReport'  //绑定元素
            , url: admin_name+'/PurchaseCheck/firstMetering' //接口
            , accept: 'file'
    ...
    exports('controller/purchases/purchaseCheck/firstMetering', {});
});