layui.define(function(exports){
    layui.use(['form','laydate','formSelects','suggest','upload'], function () {
        ...
        //上传附件
        upload.render({
            elem: '#addPriceFile'  //绑定元素
            , url: admin_name+'/Tendering/inquiryPrices' //接口
            , accept: 'file'
    ...
    exports('controller/purchases/tendering/addPrice', {});
});
