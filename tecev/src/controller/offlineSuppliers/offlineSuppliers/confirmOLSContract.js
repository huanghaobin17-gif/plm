layui.define(function(exports){
    layui.use(['table', 'layer', 'form', 'laydate', 'upload', 'tipsType', 'formSelects', 'suggest'], function () {
        ...
        laydate.render(dateConfig('#confirmOLSContractSign_date'));
        laydate.render(dateConfig('#confirmOLSContractEnd_date'));
        laydate.render(dateConfig('#confirmOLSContractCheck_date'));
        ...
        form.on('submit(confirm)', function (data) {
            ...
            console.log(params);
            submit($, params, confirmOLSContractUrl);
            return false;
        });
        ...
        uploadFile = upload.render({
            elem: '#confirmOLSContractFile'  //绑定元素
            , url: confirmOLSContractUrl //接口
            , accept: 'file'
    ...
    exports('controller/offlineSuppliers/offlineSuppliers/confirmOLSContract', {});
});
