    ...
    layui.use(['admin', 'layer', 'form', 'formSelects', 'laydate', 'table', 'suggest', 'upload', 'tablePlug', 'soulTable'], function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {
                    field: 'remaining_mounths', 
                    title: '剩余时间（月）', 
                    width: 150, align: 'center',
                    templet: function (d) {
                        if (d.remaining_mounths < 0) {
                            return '<span style="color: #FF5722;">' + d.remaining_mounths + '</span>';
                        } else {
                            return d.remaining_mounths;
                        }
                    }
                }
                , {field: 'life_expiration_date', title: '年限到期日期', width: 150, align: 'center'}
