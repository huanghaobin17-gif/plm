layui.define(function(exports){
    layui.use(['layer', 'form','suggest','element'], function() {
        ...
        //监听提交
        form.on('submit(editTemplate)', function (data) {
            var num = "";
            ...
            if (data.field['name'] == ''){
                ...
                layer.msg("请至少选一个类型明细",{icon : 2},1000);
                return false;
            }else {
                flag = true;
    ...
    exports('controller/patrol/patrolsetting/edittemplate', {});
});
