layui.define(function (exports) {
    layui.use(['form', 'table', 'tablePlug'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {
                    ...
                    templet: function (d) {
                        return d.financeid ? assetsFinance[d.financeid] : ''
                    }
                }
            ]],
            data: tableData
        ...
        table.render({
            ...
            , page: false //开启分页
            , cols: [[
                {field: 'apprid', title: '序号', width: 60, align: 'center', type: 'space', templet: function (d) {return d.LAY_INDEX;}},
                {field: 'approver', title: '审核人', minWidth: 140, align: 'center'},
                {field: 'approve_time', title: '审核时间', minWidth: 140, align: 'center'},
                {field: 'is_adopt', title: '审核状态', minWidth: 140, align: 'center',
                    templet: function (d) {
                        if (d.is_adopt === '1') {
                            return '通过'
                        }else {
                ...
                {field: 'remark', title: '审核意见', minWidth: 140, align: 'center'}
            ]],
            data: tableData_1
        });
        ...
        function initData(){
            ...
            tableData_1 = [...inventoryPlanData['apps']]
        }
