...
layui.define('view', function(exports){
  ...
  ,admin = {
    ...
    //右侧面板
    , popupRight: function (options,area) {
      var width;
      if (area){
        width = area+'px';
      }else {
  ...
  var events = admin.events = {
    ...
    , theme: function () {
      admin.popupRight({
        id: 'LAY_adminPopupTheme'
        , success: function () {
          view(this.id).render('System/themes', {
            id: 123
          })
        }
      });
    ...
    , qiehuan: function () {
      top.layer.open({
        ...
        title: '医院列表',
        area: ['560px', '300px'],
        offset: 'auto',//弹窗位置固定在右边
        anim: 2, //动画风格
        scrollbar: false,
        isOutAnim: true,
        closeBtn: 1,
        content: [admin_name+'/System/changeHospital']
      });
    }
      ...
      list.each(function(index1, item1){
        ...
        listChildren1.each(function(index2, item2){
          ...
          listChildren2.each(function(index3, item3){
            ...
            ,matched3 = (path[0] ==  data2.name && path[1] ==  data3.name)
