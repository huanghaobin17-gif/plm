...
<body>
<?php if($pw == 1): ?><div class="cus-scr">
        <div class="top">
            <div class="title"><?php echo ($hospital_name); ?></div>
            <div class="show-time">
                <div class="show-time-date"><?php echo ($today); ?>&nbsp;<span id="timebox"><?php echo ($now); ?></span></div>
        ...
        <div class="mid">
            <div class="mid-left">
                ...
                <div>
                    <div class="ty-title">
                        ...
                        <h2 class="ty-h"><span class="month_repair_order_month"><?php echo ($month); ?></span> 月份维修工单汇总</h2>
                    </div>
                ...
                <div>
                    <div class="ty-title">
                        <div class="ty-line"></div>
                        <h2 class="ty-h"><span class="month_repair_depart_month"><?php echo ($month); ?></span> 月份科室设备故障率</h2>
                    </div>
                    <div class="ty-content">
                ...
                <div>
                    <div class="ty-title">
                        <div class="ty-line"></div>
                        <h2 class="ty-h"><span class="assets_patrol_month"><?php echo ($month); ?></span> 月份保养计划情况</h2>
                    </div>
                    <div class="ty-content">
                        <div class="fg">
                            <div class="fg-d">
            ...
            <div class="mid-right">
                ...
                <div>
                    <div class="ty-title">
                        <div class="ty-line"></div>
                        <h2 class="ty-h"><span class="top_repair_month"><?php echo ($month); ?></span> 月全院 TOP10 科室报修量</h2>
                    </div>
                    <div class="ty-content">
        ...
        <div style="clear: both;"></div>
        <div class="bot">
            <img src="/Public/images/<?php echo (C("APP_MIN_LOGO")); ?>"/>&nbsp;&nbsp;<?php echo (C("COMPANY_NAME")); ?> 版权所有 &copy; 2021~2025&nbsp;&nbsp;
        </div>
    </div>
    <script>
