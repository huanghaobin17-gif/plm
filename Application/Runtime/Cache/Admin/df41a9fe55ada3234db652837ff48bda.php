...
<script>
    ...
    <script>
        var batchEditAssets = "<?php echo ($batchEditAssets); ?>";
    </script>
</head>
<body>
<div class="containDiv">
    <div style="margin: 20px 0;">
                            ...
                            <form class="layui-form">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="department" xm-select="batchEditDepartment"
                                                    xm-select-search="">
                                    ...
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" value="" autocomplete="off" class="layui-input" placeholder="请输入设备原编码" name="assorignum" />
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="checkbox" name="assetsType" value="is_firstaid" title="急救设备"
                                               lay-skin="primary">
                                        <input type="checkbox" name="assetsType" value="is_special" title="特种设备"
                                               lay-skin="primary">
                                        <input type="checkbox" name="assetsType" value="is_metering" title="计量设备"
                                               lay-skin="primary">
                                        <input type="checkbox" name="assetsType" value="is_qualityAssets" title="质控设备"
                                               lay-skin="primary">
                                        <input type="checkbox" name="assetsType" value="is_patrol" title="保养设备"
                                               lay-skin="primary">
                                        <input type="checkbox" name="assetsType" value="is_benefit" title="效益分析"
                                               lay-skin="primary">
                                        <input type="checkbox" name="assetsType" value="is_lifesupport" title="生命支持"
                                               lay-skin="primary">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline" style="width: auto">
                                            <input type="text" name="patrol_xc_cycle" class="layui-input"
                                                   style="width: 5em;">
                                            <div class="txt">天</div>
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        ...
                                        <div class="layui-input-inline" style="width: auto">
                                            <input type="text" name="patrol_pm_cycle" class="layui-input"
                                                   style="width: 5em;">
                                            <div class="txt">天</div>
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        <label class="layui-form-label">质控周期：</label>
                                        <div class="layui-input-inline" style="width: auto">
                                            <input type="text" name="quality_cycle" class="layui-input"
                                                   style="width: 5em;">
                                            <div class="txt">天</div>
                                        </div>
                                    </div>
                                    <div class="layui-inline">
                                        <label class="layui-form-label">计量周期：</label>
                                        <div class="layui-input-inline" style="width: auto">
                                            <input type="text" name="metering_cycle" class="layui-input"
                                                   style="width: 5em;">
                                            <div class="txt">天</div>
                                        </div>
                                    </div>
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-inline" style="margin-left: 10px;">
                                        <div class="fl">
                                            <button class="layui-btn" lay-submit="" lay-filter="assetsListsSearch_1"><i
                                                    class="layui-icon">&#xe615;</i> 搜 索
                                            </button>
                                            <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                                            <?php if($menuData = get_menu('Assets','Lookup','batchEditAssets')):?>
                                            <button class="layui-btn layui-btn-normal" id="batchEdit"
                                                    data-url="<?php echo ($menuData['actionurl']); ?>">
        ...
        <blockquote class="layui-elem-quote cusquote1" style="width: auto;">
            <span style="color: #000;">待维护设备列表</span>（可直接点击单个项目进行维护操作！或者选择多个设备进行批量维护操作）
        </blockquote>
        <div class="layui-card-body">
            <div id="batchEditAssetsLists" lay-filter="batchEditAssetsData"></div>
        </div>
    ...
    <div class="layui-fluid">
        <div class="layui-row">
            <form class="layui-form layui-form-pane" action="">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <label class="layui-form-label" style="width: 110px;">管理类别：</label>
                        <div class="layui-input-inline">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <select name="helpcat" lay-search>
                                ...
                                <?php if(is_array($helpcat)): $i = 0; $__LIST__ = $helpcat;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <select name="finance" lay-search>
                                ...
                                <?php if(is_array($finance)): $i = 0; $__LIST__ = $finance;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <select name="capitalfrom" lay-search>
                                ...
                                <?php if(is_array($capitalfrom)): $i = 0; $__LIST__ = $capitalfrom;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <select name="assfrom" lay-search>
                                ...
                                <?php if(is_array($assfrom)): $i = 0; $__LIST__ = $assfrom;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <select name="depreciation_method" lay-search>
                                ...
                                <?php if(is_array($depreciation_method)): $i = 0; $__LIST__ = $depreciation_method;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>
                </div>
...
<script>
    layui.use('controller/assets/lookup/batcheditassets', layui.factory('controller/assets/lookup/batcheditassets'));
</script>